<template>
  <div class="products-page">
    ...
    <div class="page-hero">
      ...
      <h1 class="page-hero__title">Collection CBD</h1>
      <div class="page-hero__divider"></div>
      <p class="page-hero__sub">Fleurs de CBD Indoor Premium — Sélection signature</p>
    </div>
...
const products = getProductsByCollection('cbd')
