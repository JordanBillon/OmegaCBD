...
export default defineEventHandler(async (event) => {
  ...
  if (updates.status === 'delivered' && body.send_email === true) {
    sendDeliveredEmail(event, client, id).catch(e =>
      console.error('Échec mail livraison:', e)
    )
  }
...
async function sendDeliveredEmail(event: any, client: any, orderId: string) {
...
<body style="margin:0;padding:0;background:#f4f4f4;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;">
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#0a0a0a;border-radius:2px;overflow:hidden;">
        ...
        <tr>
          <td style="background:#0a0a0a;padding:40px 48px 32px;text-align:center;border-bottom:1px solid #2a2a2a;">
            ...
            <h1 style="margin:0 0 16px;font-size:28px;font-weight:300;color:#fafafa;letter-spacing:0.05em;">Votre commande est livrée !</h1>
            ...
            <p style="margin:0;font-size:14px;color:#aaaaaa;line-height:1.6;">
              ${escape(sa.first_name)}, votre commande a bien été livrée.<br>
        ...
        <tr>
          <td style="padding:32px 48px 0;">
            <div style="background:#141414;border-left:3px solid #c9a96e;padding:20px 24px;">
              <p style="margin:0 0 8px;font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:#c9a96e;">Merci pour votre confiance</p>
              <p style="margin:0;font-size:14px;color:#aaaaaa;line-height:1.6;">
                Votre avis nous importe. N'hésitez pas à nous contacter si vous avez la moindre question.
              </p>
            </div>
          </td>
        </tr>
  ...
  await resend.emails.send({
    ...
    to: [userEmail],
    subject: 'Votre commande OMEGACBD est livrée !',
    html,
  })
}
